    ...
    return(
		<section id="skills" className="mt-10 sm:mt-20">
            ...
            <div className='mt-8 flex flex-col items-center justify-center gap-12 sm:flex-row md:flex-col lg:flex-row'>
                ...
                I{"\'"}m a highly motivated and adaptable programmer and community manager
                from Mexico. I{"\'"}m always seeking opportunities to learn 
                more about new technologies and development practices. 
                I{"\'"}ve a strong desire of finding new ways of problem solving.
                I also love singing and taking long walks with my dog Ofelia.
                </p>
                <Skills></Skills>
            </div>
        </section>
